...
class Courses extends React.Component {
    constructor (props){
        super(props);
        this.state = {CourseList : [] , CatInfo : props.Category , 
                      Loading : false , ShowSuccusfulAdd : false , ShowSuccusfulDel : false
                      , ShowAdd : false 
                      , ShowDel : false 
                      , CourseInfo : {id : 0 , displayname : "" , shortname : "" , TeacherName : "" , TeacherId : 0 , categoryId : (props.Category && props.Category.id) }
                      , Teachers : []};
            ...
            <React.Fragment>
                ...
                {this.state.CourseList.map((Course) => {
                    ...
                    <tr key={Course.id}>
                        ...
                        : 
                        <React.Fragment>
                            <td className="py-3" onClick={() => this.openEditMode(Course)}>{Course.displayname}</td>
        ...
        return (
            <div className="w-5/6 h-500">
                <Table
                    ...
                    options={this.state.CatInfo &&
                      <a href="#" onClick={() => this.handleShowAdd()}> {add('8', '4', '#000')} </a>
                    }
                />
          ...
          <Modal show={this.state.ShowSuccusfulAdd} onHide={this.handleCloseSuccusfulDel}>
            <Modal.Header closeButton>
              <Modal.Title>دزس جدید</Modal.Title>
            </Modal.Header>
            <Modal.Body>درس {this.state.CourseInfo.Name} با موفقیت اضافه شد </Modal.Body>
            <Modal.Footer>
