...
class Schedule extends React.Component {
    ...
    state = { layout: [
        ...
        {i: "t1", name: "07:00", x: 2, y: 0, w: 2, h: 1, static: true},
        {i: "t2", name: "08:00", x: 4, y: 0, w: 2, h: 1, static: true},
        {i: "t3", name: "09:00", x: 6, y: 0, w: 2, h: 1, static: true},
        {i: "t4", name: "10:00", x: 8, y: 0, w: 2, h: 1, static: true},
        {i: "t5", name: "11:00", x: 10, y: 0, w: 2, h: 1, static: true},
        {i: "t6", name: "12:00", x: 12, y: 0, w: 2, h: 1, static: true},
        {i: "t7", name: "13:00", x: 14, y: 0, w: 2, h: 1, static: true},
        {i: "t8", name: "14:00", x: 16, y: 0, w: 2, h: 1, static: true},
        {i: "t9", name: "15:00", x: 18, y: 0, w: 2, h: 1, static: true},
        {i: "t10", name: "16:00", x: 20, y: 0, w: 2, h: 1, static: true},
        {i: "t11", name: "17:00", x: 22, y: 0, w: 2, h: 1, static: true},
        {i: "t12", name: "18:00", x: 24, y: 0, w: 2, h: 1, static: true},
        {i: "t13", name: "19:00", x: 26, y: 0, w: 2, h: 1, static: true},
        {i: "t14", name: "20:00", x: 28, y: 0, w: 2, h: 1, static: true}
    ],
        ...
        this.props.lessons.map(day => {
            if(day && day.length > 0)
            {
                (day.map(lesson => {
                    ...
                    c: `bg-${getColor(lesson.lessonId)} border-none cursor-pointer`, x: (lesson.startHour - 8) * 2 + 2, y: lesson.dayType, w: (lesson.endHour - lesson.startHour) * 2,
    ...
    componentWillReceiveProps(){
        ...
        this.props.lessons.map(day => {
            if(day && day.length > 0)
            {
                (day.map(lesson => {
                    lessons.push({i: lesson.id + '', name: lesson.orgLessonName, teachername: lesson.firstName + " " + lesson.lastName, 
                    c: `bg-${getColor(lesson.lessonId)} border-none cursor-pointer`, x: (lesson.startHour - 7) * 2 + 2, y: lesson.dayType, w: (lesson.endHour - lesson.startHour) * 2,
