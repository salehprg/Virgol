    ...
    render(){    
        ...
        return(
            <div className="tw-w-full tw-h-screen tw-bg-auto tw-bg-vst">
                ...
                <div className="tw-text-white tw-bg-greenish tw-w-1/2 tw-text-center tw-mx-auto tw-py-4 tw-border-4 tw-text-xl tw-border-purplish tw-rounded-lg">راهنمای سامانه ویرگول مخصوص دانش آموزان</div>
