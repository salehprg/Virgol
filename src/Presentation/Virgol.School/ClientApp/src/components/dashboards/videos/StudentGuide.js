        ...
        return(
            <div className="tw-w-full tw-h-screen tw-bg-vst tw-grid tw-grid-rows-4 md:tw-grid-cols-2">
                <div>
                    ...
                    <div className="tw-text-white tw-mx-auto tw-w-1/2 tw-text-center tw-py-4 tw-border-4 tw-text-sm lg:tw-text-lg tw-border-purplish tw-rounded-lg">راهنمای سامانه ویرگول مخصوص دانش آموزان</div>  
                </div>
                <div className="tw-rows-span-3">
                    <ReactPlayer className="tw-mx-auto lg:tw-mt-24 tw-mb-4" url={url} width='90%' controls={true}/>
                    <form method="get" action="https://goldenstarc.arvanvod.com/0WobRajx6K/vrljPEyb37/origin_O7mAEwOJLjGTCu7iVrKTvnhqxXk6GTUdOcg8HluA.mp4" className="tw-text-center">
