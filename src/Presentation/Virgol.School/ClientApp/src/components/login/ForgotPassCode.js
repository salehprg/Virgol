...
class ForgotPassCode extends React.Component {
    ...
    state = { code1: "", code2: "", code3: "", code4: "", code5: "", code6: "", loading: false }
    ...
    submitCode = async () => {
        if (this.getCode().length === 6 && !this.state.loading) {
            this.setState({loading: true})
            await this.props.forgotPassword(this.props.melliCode, this.getCode());
        ...
        return(
            <div className="flex flex-col items-center">
                ...
                <button
                    ...
                    {this.state.loading ? loading("w-8 h-8 text-dark-green") : 'تایید'}
                </button>
            </div>
        );
    }
