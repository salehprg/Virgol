...
import { getAllTeachers, editCourse, deleteCourse } from "../../../../_actions/managerActions";
            ...
            <div className="w-screen min-h-screen bg-dark-green flex justify-center items-center">
                ...
                <div className="w-5/6 max-w-600 bg-white p-12 flex flex-col justify-start items-center">
                    ...
                    <div className="w-full flex md:flex-row flex-col justify-center items-center">
                        ...
                        <button onClick={() => history.push("/m/dashboard")} className="px-8 py-2 mx-2 my-2 rounded-lg font-vb text-blueish border-2 border-blueish">
                            لغو
                        </button>
...
const mapStateToProps = (state, myProps) => {
    return {
        ...
        course: state.managerData.courses.find(el => el.id === parseInt(myProps.match.params.id)),
