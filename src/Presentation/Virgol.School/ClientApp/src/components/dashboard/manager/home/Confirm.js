            ...
            <div className="w-screen min-h-screen bg-light-white flex flex-row justify-center items-center">
                ...
                <div className="w-5/6 max-w-1000 py-4 bg-white flex flex-col items-center">
                    ...
                    <div className="w-full flex flex-row justify-center flex-wrap">
                        ...
                        <button onClick={() => history.push("/m/dashboard")} className="mx-2 px-4 py-1 text-xl rounded-lg text-red-500 font-vb border-2 border-red-500">لغو</button>
                    </div>
                </div>
            </div>
        );
...
const mapStateToProps = (state, ownProps) => {
    const user = state.managerData.newUsers.find(el => el.id === parseInt(ownProps.match.params.id))
