...
import { getCatCourses, editCategory, addCoursesToCat, wipeCatInfo, deleteCategory, getAllCourses, editCourse, deleteCourseFromCat } from "../../../../_actions/managerActions";
...
const mapStateToProps = (state, myProps) => {
    return {
        ...
        category: state.managerData.categories.find(el => el.id === parseInt(myProps.match.params.id)),
        courses: state.managerData.catInfo,
        allCourses: state.managerData.courses,
