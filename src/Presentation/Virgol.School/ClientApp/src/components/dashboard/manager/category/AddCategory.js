...
import { addNewCategory } from "../../../../_actions/managerActions";
...
class AddCategory extends React.Component {
    ...
    onSubmit = () => {
        if (this.state.name === '') this.setState({ error: true })
            ...
            const formValues = { name: this.state.name }
            this.props.addNewCategory(this.props.token, formValues);
...
export default connect(mapStateToProps, { addNewCategory })(AddCategory);