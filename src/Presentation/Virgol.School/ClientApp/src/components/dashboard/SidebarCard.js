...
const SidebarCard = (props) => {
    ...
    return (
        <div
            className={`w-1/2 min-w-70 max-w-250 mx-2 md:mx-0 py-4 my-4 rounded-lg flex flex-col items-center ${props.isActive ? 'bg-blueish' : 'bg-white'} cursor-pointer transform hover:scale-110 duration-200`}
