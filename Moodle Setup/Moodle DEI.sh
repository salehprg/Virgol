...
# -------==========-------
7-https://m-dei.vir-gol.ir/admin/settings.php?section=manageauths
-- Guest login button = Hide
-- Limit concurrent logins  = 1
-- Forgotten password URL = https://dei.razaviedu.ir/
...
# -------==========-------
8- https://m-dei.vir-gol.ir/admin/settings.php?section=manageantiviruses
-- ClamAV antivirus: Enable
# -------==========-------
9- https://m-dei.vir-gol.ir/admin/category.php?category=server
-- Support name: پشتیبانی
-- Support email: admin@legace.ir
-- Support page : support.legace.ir
# -------==========-------
10- https://m-dei.vir-gol.ir/admin/settings.php?section=sessionhandling
-- Timeout: 4 Week
# -------==========-------
11- 
 Logged IP address source : first one
# -------==========-------
13- https://m-dei.vir-gol.ir/admin/category.php?category=email
...
# -------==========-------
14- https://m-dei.vir-gol.ir/admin/settings.php?section=optionalsubsystems
Enable web services 
Enable statistics 
Enable global search 
# -------==========-------
15- https://m-dei.vir-gol.ir/admin/category.php?category=roles
Hide user fields: unused
Show user identity :  ID number,  Email address
Enable Gravatar: yes
# -------==========-------
16- https://m-dei.vir-gol.ir/admin/settings.php?section=sitepolicies
...
# -------==========-------
17.1 - https://m-dei.vir-gol.ir/admin/settings.php?section=additionalhtml
add in head:
<style>
...
17.2 - https://m-dei.vir-gol.ir/admin/settings.php?section=theme_adaptable_importexport
...
https://m-dei.vir-gol.ir/admin/settings.php?section=usermanagement
 Default user filters : Email
# -------==========-------

19 - https://m-dei.vir-gol.ir/admin/settings.php?section=authsettingldap
...
20 - https://m-dei.vir-gol.ir/admin/search.php?query=enablewebservices
  Enable web Service : true 

21 - https://m-dei.vir-gol.ir/admin/settings.php?section=webserviceprotocols
  Enable REST & SOAP Protocol

22 - https://m-dei.vir-gol.ir/user/editadvanced.php?id=-1
  Username : webapiuser
...
23 - https://m-dei.vir-gol.ir/admin/roles/define.php?action=add
  Use role or archetype = ArchType:Manager 
  Click on Continue
  Short name : apirole
  Custom full name : apirole
  Context types where this role may be assigned : user
  Allow role assignments : Authenticated User
  
  webservice/rest:use = allow
  webservice/soap:use = allow

24 - https://m-dei.vir-gol.ir/admin/webservice/service.php?id=0
     Name : apiservice
     Short name : apiservice
     Enabled : true
     Authorised users only  : true

25 - https://m-dei.vir-gol.ir/admin/settings.php?section=externalservices
...
26 - https://m-dei.vir-gol.ir/admin/webservice/service_users.php?id=2
  select webapi user From rightList then click on add
  
27 - https://m-dei.vir-gol.ir/admin/roles/assign.php?contextid=1
  Click on apiRole from List then Select webapi From RighList then Click on Add

28 - https://m-dei.vir-gol.ir/admin/settings.php?section=webservicetokens
  Add new 
  User : webapi
  Service : apiservice
#Testing purpose:
